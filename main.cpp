...
int main()
{
    try
    {
        ...
        case 1:
        {
            string filepath = "D:/sonali_workspace/C++/OBJ Reader/inputfiles/Cube10.stl";
            string filepath1 = "D:/sonali_workspace/C++/OBJ Reader/outputfiles/writeSTL.txt";
        ...
        case 2:
        {
            string filepath = "D:/sonali_workspace/C++/OBJ Reader/inputfiles/cube.obj";
            string filepath1 = "D:/sonali_workspace/C++/OBJ Reader/outputfiles/writeObj.txt";
            Triangulation triangulation;
            OBJReader objReader;
        ...
        {
            string filepath = "D:/sonali_workspace/C++/OBJ Reader/inputfiles/Cube10.stl";
            string filepath1 = "D:/sonali_workspace/C++/OBJ Reader/outputfiles/StlToObj.obj";
            Triangulation triangulation;
            STLReader stlReader;
            stlReader.readSTL(filepath,triangulation);
        ...
        {
            string filepath = "D:/sonali_workspace/C++/OBJ Reader/inputfiles/cube.obj";
            string filepath1 = "D:/sonali_workspace/C++/OBJ Reader/outputfiles/ObjToStl.stl";
            Triangulation triangulation;
            OBJReader objReader;
            objReader.readOBJ(filepath, triangulation);
